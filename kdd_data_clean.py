# -*- coding: utf-8 -*-
"""
Created on Sat May 11 08:59:37 2019
...
#定义kdd99数据预处理函数
def preHandel_data():
    source_file='D:/NNlearning/code/kddcup.testdata'
    handled_file='D:/NNlearning/code/kddcup.testdata_new4'
...
def handleLabel(input):
    ...
    # 'spy.', 'rootkit.']
    '''
    label_list=['normal.', 'snmpgetattack.', 'named.', 'xlock.', 'smurf.', 'ipsweep.',
    ...
    if input[41] in label_list:
        ...
        return label_tmp[find_index(input[41],label_list)[0]]
    else:
...
if __name__=='__main__':
    ...
    global label_tmp
    #label_tmp = ['Normal','U2R','U2R','U2R','DOS','DOS', 
     #        'R2L','DOS','DOS','PROBE','PROBE','DOS','R2L', 
      #       'DOS','R2L','PROBE','R2L','PROBE','R2L','R2L','R2L',
       #      'R2L','U2R']
    label_tmp = ['Normal','R2L','R2L','R2L','DOS','PROBE',
                 'R2L','R2L','R2L','R2L','PROBE',
                 'U2R','PROBE','DOS','DOS','R2L','DOS',
                 'R2L','U2R','PROBE','U2R','PROBE','DOS',
                 'U2R','PROBE','U2R','DOS','U2R','R2L','DOS',
                 'U2R','R2L','DOS','R2L','DOS','DOS',
                 'U2R','R2L',]
